...
public final class TestDataBuilder {
  ...
  public static SubscriptionRequest createValidSubscriptionRequest() {
    return createSubscriptionRequest(
        "Netflix", new BigDecimal("15.99"), Period.MONTHLY, LocalDate.now().plusMonths(1), 1L);
  }

  public static SubscriptionRequest createSubscriptionRequest(
      String name, BigDecimal price, Period period, LocalDate nextBillingDate, Long categoryId) {
  ...
  public static Subscription createTestSubscription(
      Long id, String name, BigDecimal price, Period period, AppUser user, Category category) {
